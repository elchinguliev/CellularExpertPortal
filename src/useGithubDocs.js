...
export const DOC_INDEX = [
  ...
  { id:'ce-express-map-table-view-modes', path:'docs/ce-express/user-guide/sections/map-table-view-modes.md', title:'Map / Table View Modes', product:'CE Express', category:'Map View', order:202 },
  { id:'ce-express-database-structure-merged', path:'docs/ce-express/user-guide/sections/database-structure.md', title:'Database Structure', product:'CE Express', category:'Database Structure', order:400 },
  ...
  { id:'ce-express-exploring-data-merged', path:'docs/ce-express/user-guide/sections/exploring-data.md', title:'Exploring Data', product:'CE Express', category:'Exploring Data', order:800 },
