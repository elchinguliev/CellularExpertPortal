...
export const DOC_INDEX = [
  { id:'ce-express-v73-7-6-import-csv', path:'docs/ce-express/user-guide/v73-sections/7-6-import-csv.md', title:'Import CSV', product:'CE Express', category:'Database Organization', order:711 },
  { id:'ce-express-v73-7-5-ce-api', path:'docs/ce-express/user-guide/v73-sections/7-5-ce-api.md', title:'CE API', product:'CE Express', category:'Database Organization', order:710 },
  { id:'ce-express-v73-7-4-sieve', path:'docs/ce-express/user-guide/v73-sections/7-4-sieve.md', title:'Sieve', product:'CE Express', category:'Database Organization', order:709 },
  { id:'ce-express-v73-7-3-adding-viewing-downloading-and-deleting-attachments', path:'docs/ce-express/user-guide/v73-sections/7-3-adding-viewing-downloading-and-deleting-attachments.md', title:'Adding, viewing, downloading and deleting attachments', product:'CE Express', category:'Database Organization', order:708 },
  { id:'ce-express-v73-7-2-2-add-link', path:'docs/ce-express/user-guide/v73-sections/7-2-2-add-link.md', title:'Add link', product:'CE Express', category:'Database Organization', order:707 },
  { id:'ce-express-v73-7-2-1-set-selected', path:'docs/ce-express/user-guide/v73-sections/7-2-1-set-selected.md', title:'Set selected', product:'CE Express', category:'Database Organization', order:706 },
  ...
  { id:'ce-express-v73-7-1-3-navigation-across-tables', path:'docs/ce-express/user-guide/v73-sections/7-1-3-navigation-across-tables.md', title:'Navigation across tables', product:'CE Express', category:'Database Organization', order:704 },
  { id:'ce-express-v73-7-1-2-organization-of-columns', path:'docs/ce-express/user-guide/v73-sections/7-1-2-organization-of-columns.md', title:'Organization of columns', product:'CE Express', category:'Database Organization', order:703 },
  { id:'ce-express-v73-7-1-1-organization-of-single-and-multiple-tables', path:'docs/ce-express/user-guide/v73-sections/7-1-1-organization-of-single-and-multiple-tables.md', title:'Organization of single and multiple tables', product:'CE Express', category:'Database Organization', order:702 },
  { id:'ce-express-v73-7-1-page-setup-and-navigation', path:'docs/ce-express/user-guide/v73-sections/7-1-page-setup-and-navigation.md', title:'Page setup and navigation', product:'CE Express', category:'Database Organization', order:701 },
  ...
  { id:'ce-express-v73-6-4-view-options', path:'docs/ce-express/user-guide/v73-sections/6-4-view-options.md', title:'View options', product:'CE Express', category:'Network Data Management', order:622 },
  { id:'ce-express-v73-6-3-table', path:'docs/ce-express/user-guide/v73-sections/6-3-table.md', title:'Table', product:'CE Express', category:'Network Data Management', order:621 },
  { id:'ce-express-v73-6-2-3-user-name-help-logout', path:'docs/ce-express/user-guide/v73-sections/6-2-3-user-name-help-logout.md', title:'User name, help, logout', product:'CE Express', category:'Network Data Management', order:620 },
  { id:'ce-express-v73-6-2-2-settings', path:'docs/ce-express/user-guide/v73-sections/6-2-2-settings.md', title:'Settings', product:'CE Express', category:'Network Data Management', order:619 },
  { id:'ce-express-v73-6-2-1-import-export', path:'docs/ce-express/user-guide/v73-sections/6-2-1-import-export.md', title:'Import / Export', product:'CE Express', category:'Network Data Management', order:618 },
  { id:'ce-express-v73-6-2-view-options-and-user-administration', path:'docs/ce-express/user-guide/v73-sections/6-2-view-options-and-user-administration.md', title:'View options and user administration', product:'CE Express', category:'Network Data Management', order:617 },
  { id:'ce-express-v73-6-1-15-remove-selected', path:'docs/ce-express/user-guide/v73-sections/6-1-15-remove-selected.md', title:'Remove selected', product:'CE Express', category:'Network Data Management', order:616 },
  { id:'ce-express-v73-6-1-14-delete-record', path:'docs/ce-express/user-guide/v73-sections/6-1-14-delete-record.md', title:'Delete record', product:'CE Express', category:'Network Data Management', order:615 },
  { id:'ce-express-v73-6-1-13-export-selected', path:'docs/ce-express/user-guide/v73-sections/6-1-13-export-selected.md', title:'Export selected', product:'CE Express', category:'Network Data Management', order:614 },
  { id:'ce-express-v73-6-1-12-ce-api', path:'docs/ce-express/user-guide/v73-sections/6-1-12-ce-api.md', title:'CE API', product:'CE Express', category:'Network Data Management', order:613 },
  { id:'ce-express-v73-6-1-11-add-new-record', path:'docs/ce-express/user-guide/v73-sections/6-1-11-add-new-record.md', title:'Add new record', product:'CE Express', category:'Network Data Management', order:612 },
  { id:'ce-express-v73-6-1-10-copy-record', path:'docs/ce-express/user-guide/v73-sections/6-1-10-copy-record.md', title:'Copy record', product:'CE Express', category:'Network Data Management', order:611 },
  { id:'ce-express-v73-6-1-9-move-record', path:'docs/ce-express/user-guide/v73-sections/6-1-9-move-record.md', title:'Move record', product:'CE Express', category:'Network Data Management', order:610 },
  { id:'ce-express-v73-6-1-8-show-selectedshow-all', path:'docs/ce-express/user-guide/v73-sections/6-1-8-show-selectedshow-all.md', title:'Show selected/show all', product:'CE Express', category:'Network Data Management', order:609 },
  { id:'ce-express-v73-6-1-7-selectunselect-all', path:'docs/ce-express/user-guide/v73-sections/6-1-7-selectunselect-all.md', title:'Select/unselect all', product:'CE Express', category:'Network Data Management', order:608 },
  { id:'ce-express-v73-6-1-6-synchronize-changes', path:'docs/ce-express/user-guide/v73-sections/6-1-6-synchronize-changes.md', title:'Synchronize changes', product:'CE Express', category:'Network Data Management', order:607 },
  { id:'ce-express-v73-6-1-5-view-attachments', path:'docs/ce-express/user-guide/v73-sections/6-1-5-view-attachments.md', title:'View attachments', product:'CE Express', category:'Network Data Management', order:606 },
  { id:'ce-express-v73-6-1-4-multiple-table-view', path:'docs/ce-express/user-guide/v73-sections/6-1-4-multiple-table-view.md', title:'Multiple table view', product:'CE Express', category:'Network Data Management', order:605 },
  { id:'ce-express-v73-6-1-3-sieve', path:'docs/ce-express/user-guide/v73-sections/6-1-3-sieve.md', title:'Sieve', product:'CE Express', category:'Network Data Management', order:604 },
  { id:'ce-express-v73-6-1-2-back', path:'docs/ce-express/user-guide/v73-sections/6-1-2-back.md', title:'Back', product:'CE Express', category:'Network Data Management', order:603 },
  { id:'ce-express-v73-6-1-1-table-view', path:'docs/ce-express/user-guide/v73-sections/6-1-1-table-view.md', title:'Table view', product:'CE Express', category:'Network Data Management', order:602 },
  { id:'ce-express-v73-6-1-data-management-tools', path:'docs/ce-express/user-guide/v73-sections/6-1-data-management-tools.md', title:'Data management tools', product:'CE Express', category:'Network Data Management', order:601 },
  ...
  { id:'ce-express-map', path:'docs/ce-express/user-guide/v73-sections/3-2-map.md', title:'Map', product:'CE Express', category:'Map View', order:201 },
  ...
  { id:'ce-express-v73-8-6-test-if-it-works', path:'docs/ce-express/user-guide/v73-sections/8-6-test-if-it-works.md', title:'Test if it works', product:'CE Express', category:'Exploring Data', order:806 },
