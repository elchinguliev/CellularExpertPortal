...
Cellular Expert Desktop Indoor for ArcGIS Pro 
User Guide 
...
Cellular Expert Desktop Indoor for ArcGIS Pro User Guide 
...
1.  Choose the 
 ...
 button from the toolbar and select Cell from the dropdown list. 
...
(NLOS)  areas  uses  empirically  determined  parameters  defined 
ITU-R  and  3GPP 
