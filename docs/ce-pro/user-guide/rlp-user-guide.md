...
Cellular Expert Desktop RLP for ArcGIS Pro 
User Guide 
...
than  170  communication  network 
...
trademarks,  @cellular-expert.com 

and 

are  service  marks  of  UAB 
...
CE  Pro  is  a  purpose-built  extension  of  ESRI  software,  a  world-renowned  standard  in  GIS 
...
CE Pro is made of several processing engines and functional modules and therefore may be 
...
CE  Pro  is  maintained  and  constantly  developed  by  a  dedicated  agile  team  of  software 
...
Site and cell level details of radio equipment complement, specifications, cell and component 
carriers configuration, 
Subscriber  characteristics  –  geographic  distribution  density,  generated  traffic  to  estimate 
network/cell loading, 
DTM,  buildings,  and  clutter-based  deterministic  point-to-area  radio  wave  propagation 
modeling. 
...
information:  https://blog.maxar.com/earth-intelligence/2022/benefits-of-using-maxars-precision3d-
...
data topic. Click on 
 ...
 Browse button to define Geodata catalog. Geodata must have specific names: 
...
•  Click  the  browse  button   
  ...
  and  locate  your  layer  file  (for  example  “C:\Program  Files\Cellular 
...
Click the  
 ...
 button and select the Properties tab to open the CE Express Connection dialogue. 
...
1.  Choose the 
 ...
 button from the toolbar and select Sites from the dropdown list. 
...
Choose the 
 ...
 button from the toolbar and select Links from the dropdown list. 
...
Add the performance objective by pressing the 

 button. 

To delete the objective, select it in the table and press the 
...
Choose the 
 ...
 button from the toolbar and select MeshNodes from the dropdown list. 
...
Choose the 
 ...
 button to open the Object Editor dialogue. 
...
Select tool and press the Move Objects button in the Object Editor. 
  ...
  button  to  open  the  Object  Editor  dialogue.  Select  the  desirable  Link  objects  with  the 
...
press the Duplicate Objects button in the Object Editor dialogue. 
 ...
 button to open the Object Editor dialogue. Select the Link object with the Select tool and 
...
tool and press the Move Objects button in the Object Editor. 
 ...
 button to open the Object Editor dialogue. Select the desirable objects with the Select 
...
press the Duplicate Objects button in the Object Editor dialogue. 
 ...
 button to open the  Object  Editor  dialogue.  Select  the object with  the  Select tool and 
...
Choose the 
 ...
 button to open the Clutter Classes dialogue. 
...
Click the 
 ...
 button to open the Antenna Viewer. Change Antenna Type to Parabolic. 
...
To open the Prediction Model Manager dialogue, click on the Prediction Model Manager 
...
•  Hata Loss: A3 - Okumura-Hata type of multiplying factor for log(hM)log(d). Default value 0.1. 
...
them. 
 ...
 button to open the Template Manager dialogue. Select one of the opened templates to edit 
...
To create a new Modulation template, press 
new template. 
...
Assign modulation to the template. 
 ...
 button in the top right corner of the dialog to initialize a 
...
To add a new modulation, click the 
 at the top right of the Modulation Editor window to initialize a new 
...
the object, which should be imported. 
 ...
 button to open the Import Objects dialogue. Expand Import drop-down menu and select 
...
If your data structure is different compared to Cellular Expert database, then Mapping file should 
...
Click  the  toolbar  button 
    and  select  Import  to  import  antenna  patterns.  The  command  opens  a 
...
local hard drive, check the desired antennas, and click the Export button. 
 ...
 button and select Export to export antenna patterns. Select the Export path on your 
...
Click  on  the 
  button  and  select  Create  to  create  antenna  patterns.  Various  parameters  of  the 
...
Click  the 
  button  to  open  the  Radios  Dockpane.  The  dock  pane's  Manager  tab  includes  the 
...
are listed in a dropdown below the table. The selected modulation can be assigned to a radio by pressing 
  ...
  button.  Several  modulations  can  be  assigned  to  a  radio,  and  the  parameters  of  the  assigned 
...
Click the 
 ...
 button to open the Spectrum Masks dialogue. 
...
Click the 
 ...
 button to open the Frequency Plans dialogue. 
...
Click the 
 ...
 button to open the Profile dialogue.  
...
The 
 ...
 button allows you to see the Prediction Calculation results. 
...
To update the values, either select an unselected row or press the 
...
The 
 ...
 button toggles the Dynamic Profile. 
...
Click on the 
 ...
 button to open the CE Calculation Task List dialogue. 
...
from the task list by clicking 
 on the right side of the task. To open a result raster, select it from the results 
...
Click the 
 ...
 button to open the Visibility Prediction dialogue. 
...
Click the 
 ...
 button to open Mesh Connectivity dialogue. 
...
Click the 
 ...
 button to open Quick Mesh Connectivity dialogue. 
...
Click the 
 ...
 button to open the Geoclimatic Data dialogue. 
...
Linear/Logarithmic 
Specifies how the axes values are calculated and displayed on the plot. Logarithmic is calculated as log10. 
...
Click the 
 ...
 button to open the Link Prediction dialogue. 
...
Click the 
 ...
 button to open the Automatic Frequency Planning tool. 
...
Click the 
 ...
 button to open the License Information dialogue. 
...
Click the 
 ...
 button in the Help dropdown list to open the Documentation of CE for ArcGIS Pro. 
...
12.2.2  What’s New 
 ...
 button in the Help dropdown list to open the What’s New document. This document 
Click the 
...
Click the 
button in the Help dropdown list to open the Technical Support page in your 
...
Click the 
 ...
 button in the Help dropdown list to open the Error Log dialogue. 
