...
Information about CE Express Inventory3D database 
...
is  enabled  use  https  protocol 

to  access 

the  CE  Express  application 
...
A new user group can  be added by clicking on 
database) 

 (Note that  new users are added only directly in the 
